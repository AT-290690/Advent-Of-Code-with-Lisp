...
(let part1 (lambda input (do
    ...
    (let combo (lambda operand (cond
        ...
        (= operand 7) (log-string! "7 is reserved and SHOULD NOT appear in valid programs!")
        (*) (log-string! (array:push! "Invalid combo operand " operand))
    )))
    ...
    (let opcodes (lambda opcode operand 
        (cond
            ...
            (*) (log-string! "Invalid instruction"))))
